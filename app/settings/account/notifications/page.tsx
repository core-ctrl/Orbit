...
export default function PlaceholderPage() {
  return (
    <div className="p-8 max-w-4xl">
      <div className="mb-8">
        <h1 className="text-2xl font-semibold text-text-primary mb-2">Notification Preferences</h1>
      ...
      <div className="p-12 border border-border rounded-xl bg-card flex flex-col items-center justify-center text-center">
        ...
        <p className="text-sm text-text-muted max-w-md">
          Advanced notification preferences configurations will be available in the upcoming enterprise release. 
